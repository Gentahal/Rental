                ...
                <div class="card-body ">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title text-primary">Edit Kendaraan</h3>
                                    <form action="{{ route('admin.update', $kendaraan->id) }}" enctype="multipart/form-data" method="POST">
                                        @csrf
                                        {{ method_field('PUT') }}
                                        <div class="row mb-3">
                                            <label for="inputNumber" class="col-sm-2 col-form-label">Nama Kendaraan</label>
                                            <div class="col-sm-10">
                                                <input value="{{ $kendaraan->nama_kendaraan }}" class="form-control @error('nama_kendaraan') is-invalid @enderror"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input value="{{ $kendaraan->warna }}" class="form-control @error('warna') is-invalid @enderror"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea value="{{ $kendaraan->deskripsi }}" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" id="formFile" cols="10" rows="5" required>@error('deskripsi')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                                    @enderror</textarea>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input value="{{ $kendaraan->tahun }}" class="form-control @error('tahun') is-invalid @enderror"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control @error('foto') is-invalid @enderror"
                                                    name="foto" value="{{ $kendaraan->foto }}" type="file" id="formFile" required onchange="previewFile(this)">
                                                @error('foto')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input value="{{ $kendaraan->tarif }}" class="form-control @error('tarif') is-invalid @enderror"
